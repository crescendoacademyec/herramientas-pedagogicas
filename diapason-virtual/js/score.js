    ...
    // Guitarra, ukelele y requinto se escriben habitualmente una octava por encima
    ...
    window.addEventListener('load', function() {
      ...
      instrumentSel.value = (s.instrument&&INSTRUMENTS[s.instrument])?s.instrument:'guitar';
