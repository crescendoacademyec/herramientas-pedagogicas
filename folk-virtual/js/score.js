    ...
    function getCurrentStepData(tempo){
      const stepSeconds=ScorePlaybackTiming.stepSeconds(osmd.cursor.Iterator,tempo); const notes=[]; const midis=[]; const octaveOffset=-(Number(activeInstrument?.().writtenTranspose||0));
      try{
