  ...
  levels: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          title: "Solfeo cromático: Do, Di, Re, Ri…",
          html: `<p>El <b>solfeo cromático</b> emplea sílabas diferentes para las notas naturales y ciertas alteraciones. Usaremos la misma convención que en Piano Virtual, con <b>Do = C</b> en esta práctica. No trasladamos Do según la tonalidad: eso sería otra modalidad, Do movible.</p><div class="table-scroll"><table class="music-reference-table"><caption>Sílabas cromáticas y notas correspondientes</caption><thead><tr><th scope="col">Natural</th><th scope="col">Elevada un semitono</th><th scope="col">Rebajada un semitono</th></tr></thead><tbody><tr><td>C · Do</td><td>C♯ · Di</td><td>—</td></tr><tr><td>D · Re</td><td>D♯ · Ri</td><td>D♭ · Ra</td></tr><tr><td>E · Mi</td><td>—</td><td>E♭ · Me</td></tr><tr><td>F · Fa</td><td>F♯ · Fi</td><td>—</td></tr><tr><td>G · Sol</td><td>G♯ · Si</td><td>G♭ · Se</td></tr><tr><td>A · La</td><td>A♯ · Li</td><td>A♭ · Le</td></tr><tr><td>B · Ti</td><td>—</td><td>B♭ · Te</td></tr></tbody></table></div><p>Las rayas indican grafías que no se practican en este ejercicio introductorio; no significan que esas notas no puedan alterarse.</p><div class="lesson-example"><b>Importante:</b> el nombre español Si corresponde a B, pero aquí B se canta <b>Ti</b>. La sílaba cromática <b>Si</b> corresponde a G♯ (Sol sostenido).</div><p><b>Ascenso con sostenidos:</b> Do–Di–Re–Ri–Mi–Fa–Fi–Sol–Si–La–Li–Ti–Do.</p><p><b>Descenso con bemoles:</b> Do–Ti–Te–La–Le–Sol–Se–Fa–Mi–Me–Re–Ra–Do.</p><p>C♯ y D♭ coinciden en altura en el piano temperado, pero se solfean <b>Di</b> y <b>Ra</b> según su escritura. Subir no obliga siempre a usar sostenidos ni bajar a usar bemoles: estas dos secuencias son ejemplos de práctica.</p><p><b>Practica:</b> selecciona «Solfeo cromático» en el entrenador, escucha la nota con el piano, cántala y elige su sílaba. El ejercicio comprueba tu respuesta seleccionada; no evalúa la afinación de tu voz.</p>`
        },
        {
