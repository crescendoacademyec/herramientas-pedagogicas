...
(function (global) {
  ...
  function filename(title) { return "./Library/" + encodeURIComponent(title + " - ATA.json"); }
  ...
  function mount(root) {
    root.innerHTML='<section class="ata-library"><div class="ata-tools"><input data-ata="search" type="search" placeholder="Busca entre los '+TITLES.length+' standards…"></div><div class="ata-results" data-ata="results"></div><p class="ata-load">Catálogo generado desde la carpeta <code>Library</code>: escribe una palabra y selecciona el standard. Los resultados se limitan a 60 para mantener la búsqueda ágil.</p><div class="ata-meta" data-ata="meta">Elige un standard para abrir su análisis ATA.</div><div data-ata="chart" class="ata-empty">Sin chart seleccionado.</div></section>';
