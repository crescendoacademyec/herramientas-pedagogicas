...
const LEVELS = [
  ...
  // ============================================================
  {
    ...
    topics: [
      ...
      {
        title: "1.1b Tabla visual completa de acordes",
        html: `
          <p>Un método clásico de Berklee para aprender armonía sugiere memorizar <b>todos</b> los tipos de
          acordes posibles antes de avanzar — desde la quinta simple hasta las tétradas más densas con varias
          tensiones. Aquí tienes la tabla completa, con el diagrama de piano y el mapa de notas en guitarra de
          cada uno, para que puedas verlos y no solo leerlos.</p>
          <div id="chordRefMount"></div>
        `
      },
      {
  ...
  // ============================================================
  {
    ...
    topics: [
      ...
      {
        title: "2.10 Resolución deceptiva (cadencia rota)",
        html: `
          <p>Una <b>resolución deceptiva</b> (o cadencia rota/interrumpida) ocurre cuando un V7 no resuelve al
    ...
    topics: [
      ...
      },
      {
        ...
        html: `
          ...
          <p><b>Construcción práctica de un V7alt:</b> puedes armar el voicing completo combinando el
          <b>bajo del dominante original</b> + la <b>tétrada completa de su sustituto tritonal (subV7)</b> +
          una <b>tríada aumentada</b> (por terceras mayores) que aporte el resto de tensiones. Ejemplo sobre
          <b>G7alt</b>: bajo <b>G</b> + tétrada de <b>Db7</b> (Db-F-Ab-Cb) + tríada aumentada <b>Ab-C-E</b>
          — el resultado contiene todas las tensiones alteradas (b9, #9, #11, b13) sin tener que memorizar
          la escala alterada nota por nota.</p>
        `
      },
      {
  ...
  // ============================================================
  {
    ...
    topics: [
      ...
      {
        title: "4.12 Repertorio recomendado del Real Book — Nivel 4",
        html: `
